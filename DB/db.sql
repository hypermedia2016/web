...
INSERT INTO `assistance_types` (`id`, `name`, `img`) VALUES
  ...
  (2, 'Payments', '02_CostiPagamenti_0.png'),
...
INSERT INTO `promotions_device` (`id`, `device_id`, `title`, `description`, `img`) VALUES
  (1, 5, 'There\'s nothing like an iphone', 'Enjoy the best mobile experience at a great price', 'iphone_group.png'),
  (2, 1, 'Galaxy S7, more than a smartphone', 'Enjoy the most powerful android phone ever at a great price', 'home-1.png');
...
INSERT INTO `services` (`id`, `name`, `short_description`, `price`, `type_id`, `img`, `full_description`, `features`, `rules`, `faq`, `faq_titles`, `img_tag`) VALUES
  (1, 'Verizon next', 'Tired with having an obsolete device? With Verizon Next you can exchange your device at no expenses with a more recent one so you will be always ahed', 19.99, 1, 'Latest-Smartphones-with-2-GB-RAM-In-India.jpg', 'Verizon Next is a verizon service that lets you replace easily your smartphone with a new one year by year at a small montly fee of 19,99 €. You can for example buy a Samsung Galaxy S7 today and replace with the new S8 within a year from the bought of the latter.', 'Get the latest smartphone ready to be used with a small monthly fee||We will configure your new smartphone right away. No time spent to find out to restore your contacts anymore||Your new smartphone will come with an extended 3 year warranty by default', 'The service requires a minimum period of 24 months and a valid credit card to perform payments. You can change your device once per year with a new one of the same price and quality category. You will be required to visit a Verizon Store to perform the exchange and bring with your previous phone in perfect conditions, with all its orginal accessories and box. Phones that do not respect this condition will not be exchanged unless you will pay a fee proportional to the condition of the phone.||To activate the service, click subscribe and follow the instructions after logging in with your verizon account, or visit a Verizon Store. Deactivating the service is free after the 24 months of agreed period, otherwise you will be forced to pay a 100$ fee.||All this conditions are explicitly mentioned in the service contract you will be signing or confirming to enjoy this service. The contract represent a legally valid document that will authorize us to take countermeasure against rules violation or abuse.', 'You can subscribe to the service by pressing the "SUBSCRIBE" button, log in with your verizon account and follow the instructions. Or you can visit one of our Verizon Stores||Every year Verizon Next gives you the change to exchange your smartphone with a new one. This new smartphone will be of the same price range of  your previous smartphone||This service requires you to use a credit card. This credit card must be belonging to one of the following payment circuits: Visa, MasterCard, American Express, Diners Club', 'How can i subscribe to the service||What smartphone will be exchanged with mine||What payment method do you accept', 1),
  (2, 'Verizon music', 'Stream your favourite music anywhere with your connected devices', 300, 2, 'banner-2_1.jpg', 'Verizon Music is a verizon service that lets you stream over 10 millions songs, create playlists and discover new music at just 9,99€/month. You can enjoy it on every platform: Android, iOS, Windows Phone, Smart TVs, Browser', 'Create, share and discover music playlists||Listen to over 10 millions songs||Enjoy music without adds  or commercials||Enjoy the experience with your smartphone, tablet, broswer or tv', 'The service let you stream unlimited songs from our music catalog for 9,99€/month.\r\nNo minimum period of use is required for this service, nor any exit fee. This service requires you to install an application on a compatible device. The compatible devices must have the following characteristics: Android OS version >4.0 or iOS version >7 or Windows Mobile OS version > 8, internet connection, at least 50MB of free space. Even if you install the application you cannot join the service unless you have payed the 9,99 euro rate and unless you have a Verizon account. The subscription will be automatically renewed month by month on the first day of each month, unless you unsubscribe to the service.||All this conditions are explicitly mentioned in the service contract you will be signing or confirming to enjoy this service. The contract represent a legally valid document that will authorize us to take countermeasure against rules violation or abuse.', 'You can subscribe to the service by pressing the "SUBSCRIBE" button, log in with your verizon account and follow the instructions. Or you can visit one of our Verizon Stores||You are allowed to store offline up to 2GB of music. Note that this music will only be available through the Verizon Music App and only for your device. If you decide to unsubscribe from the service, your offline catalogue will be erased||You can enjoy the service on a maximum of three devices with your single account. This limit is imposed to prevent abuse of service', 'How can I subscribe to the service||Can I store music offline||Can I enjoy the service on multiple devices', 2),
  (3, 'Verizon Pay', 'Safe and super easy mobile payments', 250, 3, 'coupon.jpg', 'Verizon pay gives you an electronic wallet protected and made accessible for everyone via the Verizon network. Install the app on selected devices, link your credit card and everything is done for you ', 'Portable electronic payment wallet on your smartphone||End to end encryption via SSL and SEC||Dedicated 24h support line||Available both for online and offline purchases', 'The service let you perform mobile payments through NFC for free.\r\nNo minimum period of use is required for this service, nor any exit fee. This service requires you to install an application on a compatible device. The compatible devices must have the following characteristics: Android OS version >4.0 or iOS version >7 or Windows Mobile OS version > 8, internet connection, at least 50MB of free space, NFC. Even if you install the application you cannot join the service unless you have payed the 9,99 euro rate and unless you have a Verizon account with it enabled. The service requires you to connect your bank account or analog money accounts(Paypal, debit cards) in order to actually make the payment. The service will let you make mobile payments only with NFC enabled POS. On your verizon account you will be able to track the history of all your payments. Note that Verizon Pay does not represent a debit/credit card nor other similar money instruments, but just a payment gateway||All this conditions are explicitly mentioned in the service contract you will be signing or confirming to enjoy this service. The contract represent a legally valid document that will authorize us to take countermeasure against rules violation or abuse.', 'You can subscribe to the service by pressing the "SUBSCRIBE" button, log in with your Verizon account and follow the instructions. Or you can visit one of our Verizon Stores||Unfortunately no. We are working to porting the service to the web to simplify payments. Keep checking our news to find out when we will make this feature available||Yes you can. You will be asked to select the bank account of your choice at each payment, or you can set a default bank account to use', 'How can I subscribe to the service||Can I use the service for online payments?||Can I link multiple bank accounts to the service?', 3);
...
INSERT INTO `services_types` (`id`, `name`, `img`) VALUES
  ...
  (2, 'Stay entertained', 'entertainment_icon.png'),
