...
},{"strict-uri-encode":18}],18:[function(require,module,exports){
'use strict';
...
},{"./components/bootstrap":47,"bootstrap/dist/js/npm":1,"jquery":15,"vue":43,"vue-resource":32}],45:[function(require,module,exports){
'use strict';
...
Vue.component('assistance-details', {
    ...
    ready: function ready() {
        ...
        $(window).on('hashchange', function () {
            _this.locations.pop();_this.locations.pop();_this.locations.pop();_this.loadAssistance();
        });
    },
...
Vue.component('assistance', {
    ...
    methods: {
        ...
        loadTab: function loadTab(name) {
            ...
            this.$http({ url: basicUrl + '/api/assistance.php?type=' + encodeURIComponent(name), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
...
},{"jquery-stickytabs":14}],47:[function(require,module,exports){
'use strict';
...
},{"./assistance":46,"./assistance-details":45,"./device":48,"./devices":49,"./index":50,"./service":51,"./services":52,"./the-group":53,"./who-we-are":54}],48:[function(require,module,exports){
'use strict';
...
Vue.component('device', {
    ...
    ready: function ready() {
        ...
        var _this = this;
        $(window).on('hashchange', function () {
            _this.locations.pop();_this.locations.pop();_this.locations.pop();_this.loadDevice();
        });
    },
...
Vue.component('devices', {
    ...
    methods: {
        loadTab: function loadTab(name) {
            ...
            this.locations.pop();
            this.locations.push({ name: name, url: '#' + name.toLowerCase() });
            this.$http({ url: basicUrl + '/api/devices.php?type=' + encodeURIComponent(name), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
        ...
        filterText: function filterText(filter, type) {
            if (type == 'price') return this.priceFilterText(filter);
            return filter.name;
        },
        ...
        filterClicked: function filterClicked(filter, type, event) {
            ...
            if (type == 'price') this.filterPrice(filter);else this.devicesFiltered = this.content.devices.filter(function (item) {
...
},{"jquery-stickytabs":14,"query-string":17}],50:[function(require,module,exports){
'use strict';
...
Vue.component('service', {
    ...
    ready: function ready() {
        ...
        var _this = this;
        $(window).on('hashchange', function () {
            _this.locations.pop();_this.locations.pop();_this.locations.pop();_this.loadService();
        });
    },
...
Vue.component('services', {
    ...
    methods: {
        ...
        loadTab: function loadTab(name) {
            ...
            this.locations.pop();
            this.locations.push({ name: name, url: '#' + name.toLowerCase() });
            this.$http({ url: basicUrl + '/api/services.php?type=' + encodeURIComponent(name), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
...
},{"jquery-stickytabs":14}],53:[function(require,module,exports){
'use strict';
...
},{"jquery-stickytabs":14}],54:[function(require,module,exports){
'use strict';
