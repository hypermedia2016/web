...
},{"object-assign":19,"strict-uri-encode":20}],19:[function(require,module,exports){
'use strict';
...
},{"./components/bootstrap":26,"bootstrap/dist/js/npm":1,"jquery":15,"vue":22,"vue-resource":21}],24:[function(require,module,exports){
'use strict';
...
Vue.component('assistance-details', {
    ...
    ready: function ready() {
        ...
        $(window).on('hashchange', function () {
            _this.locations.pop();_this.locations.pop();_this.locations.pop();_this.loadAssistance();_this.loadDevices();
        });
    },


    methods: {
        loadAssistance: function loadAssistance() {
            ...
            var _this = this;
            this.$http({ url: basicUrl + '/api/assistance-details.php?id=' + id, method: 'GET' }).then(function (response) {
        ...
        getAssistanceId: function getAssistanceId() {
            var id = window.location.hash.substr(1); //remove #
            if (isNaN(id) || id <= 0) return null;else return id;
        },
        ...
        createGroupedArray: function createGroupedArray(arr, chunkSize) {
            var groups = [],
                i;
        ...
        loadDevices: function loadDevices() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/device-assistance.php?assistance_id=' + this.getAssistanceId(), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
                    tmp = tmp.map(function (ele) {
                        ele.img = ele.img.split('||').map(function (ele2) {
                            return basicUrl + '/img/dynamic/' + ele2;
                        });
                        return ele;
                    });
    ...
    filters: {
        ...
        realUrls: function realUrls(data) {
            return data.replace(/src=\"([^\"]*)\"/gi, 'src="' + basicUrl + '/img/dynamic/$1"');
        },
        customTags: function customTags(data) {
            if (data == undefined) data = '';
...
},{"marked":16}],25:[function(require,module,exports){
'use strict';
...
Vue.component('assistance', {
    ...
    ready: function ready() {
        ...
        $(window).on('hashchange', function () {
            if (location.hash == '') {
                ...
                _this.home = false;
                if (_this.locationOriginalLength == _this.locations.length) _this.locations.push({ name: location.hash.slice(1), url: location.hash.slice(1) + '.html' }); //TODO improove
            }
        });
    },
    ...
    methods: {
        ...
        loadTab: function loadTab(name) {
            var _this = this;
            if (!this.home) this.locations.pop();
            this.locations.push({ name: name, url: '#' + name.trim().toLowerCase() });
            this.$http({ url: basicUrl + '/api/assistance.php?type=' + encodeURIComponent(name.trim()), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
        ...
        loadTypes: function loadTypes() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/assistance-types.php', method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    //parse and store result
                    var data = response.data;
                    data.forEach(function (type, key) {
                        var tmp = type;
        ...
        loadFrequents: function loadFrequents() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/assistance-frequent.php', method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
...
},{"jquery-stickytabs":14}],26:[function(require,module,exports){
'use strict';
...
},{"./assistance":25,"./assistance-details":24,"./device":27,"./devices":28,"./index":29,"./service":30,"./services":31,"./the-group":32,"./who-we-are":33}],27:[function(require,module,exports){
'use strict';
...
Vue.component('device', {
    ...
    ready: function ready() {
        ...
        var _this = this;
        $(window).on('hashchange', function () {
            _this.locations.pop();_this.locations.pop();_this.locations.pop();_this.loadDevice();_this.loadAssistance();_this.loadServices();
        });
    },
    ...
    methods: {
        loadDevice: function loadDevice() {
            ...
            var _this = this;
            this.$http({ url: basicUrl + '/api/device.php?id=' + id, method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
        ...
        createPresentationSections: function createPresentationSections() {
        ...
        createSpecItems: function createSpecItems() {
            ...
            try {
                for (var _iterator = rawSpecs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        loadServices: function loadServices() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/device-service.php?device_id=' + this.getDeviceId(), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
        ...
        loadAssistance: function loadAssistance() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/device-assistance.php?device_id=' + this.getDeviceId(), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
        ...
        switchImg: function switchImg(id) {
            this.toShowImg = id;
        }
    }
});
...
Vue.component('devices', {
    ...
    methods: {
        loadTab: function loadTab(name) {
            ...
            this.locations.pop();
            this.locations.push({ name: name, url: '#' + name.trim().toLowerCase() });
            this.$http({ url: basicUrl + '/api/devices.php?type=' + encodeURIComponent(name.trim()), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
                    tmp.devices = tmp.devices.map(function (ele) {
                        ele.colors = ele.colors.split('||');
                        ele.img = ele.img.split('||').map(function (ele2) {
                            return basicUrl + '/img/dynamic/' + ele2;
                        });
        ...
        loadTypes: function loadTypes() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/devices-types.php', method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    //parse and store result
        ...
        getFilter: function getFilter() {
            ...
            if (Object.keys(this.activeFilter).length != 0) this.keepActiveFilter = true;
        },
        filterText: function filterText(filter, type) {
            if (type == 'price') return this.priceFilterText(filter.split('_'));
            if (filter.name != undefined) return filter.name;
            return filter;
        },
        priceFilterText: function priceFilterText(price) {
            if (price[0] == 0) return 'Less than ' + price[1] + '€';else if (price[1] == -1) return 'Greater than ' + price[0] + '€';else return 'Between ' + price[0] + '€ and ' + price[1] + '€';
        },
        filterPrice: function filterPrice(price) {
            if (price[1] == -1) this.devicesFiltered = this.content.devices.filter(function (item) {
                return item['price'] * 1 >= price[0];
            });
            //This case covers also the case "less than"
            else this.devicesFiltered = this.content.devices.filter(function (item) {
                    return item['price'] * 1 >= price[0] && item['price'] * 1 <= price[1];
                });
        },
        filterClicked: function filterClicked(filter, type, event) {
            if (event != null) event.preventDefault();
            if (type == 'price') {
                if (filter.name != undefined) filter = filter.name; //tmp fix for setData case
                this.setCurrentFilter(type, filter);
                this.filterPrice(filter.split('_'));
            } else {
                this.setCurrentFilter(type, filter.name);
                this.devicesFiltered = this.content.devices.filter(function (item) {
                    return item[type] == filter.name;
                });
            }
        },
        specialFilterClicked: function specialFilterClicked(filter, event) {
            if (event != null) event.preventDefault();
            this.setCurrentFilter(filter, undefined);
            if (filter == 'All') this.devicesFiltered = this.content.devices;else this.devicesFiltered = this.content.devices.filter(function (item) {
                return item.characteristics.includes(filter);
            });
        },
        setCurrentFilter: function setCurrentFilter(name, value) {
            this.activeFilter = {};
    ...
    computed: {
        shutCurrentFilter: function shutCurrentFilter() {
...
},{"jquery-stickytabs":14,"query-string":18}],29:[function(require,module,exports){
'use strict';
...
Vue.component('index', {
    ...
    methods: {
        loadPromotionsService: function loadPromotionsService() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/promotions-service.php', method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
        ...
        loadPromotionsDevice: function loadPromotionsDevice() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/promotions-device.php', method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
...
Vue.component('service', {
    ...
    ready: function ready() {
        ...
        var _this = this;
        $(window).on('hashchange', function () {
            _this.locations.pop();_this.locations.pop();_this.locations.pop();_this.loadService();_this.loadDevices();
        });
    },
    ...
    methods: {
        loadService: function loadService() {
            ...
            var _this = this;
            this.$http({ url: basicUrl + '/api/service.php?id=' + id, method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
        ...
        loadDevices: function loadDevices() {
            ...
            var _this = this;
            this.$http({ url: basicUrl + '/api/device-service.php?service_id=' + this.getServiceId(), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
                    ...
                    _this.devices = _this2.createGroupedArray(tmp, 3);
                    _this.error = '';
                }
            }, function (response) {
                _this.error = 'Loading error...';
        ...
        createFaqSections: function createFaqSections() {
        ...
        createRuleSections: function createRuleSections() {
        ...
        createFeaturesSections: function createFeaturesSections() {
...
Vue.component('services', {
    ...
    methods: {
        ...
        loadTab: function loadTab(name) {
            ...
            this.locations.pop();
            this.locations.push({ name: name, url: '#' + name.trim().toLowerCase() });
            this.$http({ url: basicUrl + '/api/services.php?type=' + encodeURIComponent(name.trim()), method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
        ...
        loadTypes: function loadTypes() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/services-types.php', method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    //parse and store result
...
},{"jquery-stickytabs":14}],32:[function(require,module,exports){
'use strict';
...
Vue.component('the-group', {
    ...
    methods: {
        loadNews: function loadNews() {
            var _this = this;
            this.$http({ url: basicUrl + '/api/news.php', method: 'GET' }).then(function (response) {
                if (response.data.error != undefined) {
                    _this.error = response.data.error;
                } else {
                    var tmp = response.data;
...
},{"jquery-stickytabs":14}],33:[function(require,module,exports){
'use strict';
